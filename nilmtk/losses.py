from sklearn.metrics import mean_squared_error, mean_absolute_error, f1_score, r2_score, matthews_corrcoef, max_error, accuracy_score
import numpy as np

def maxerror(app_gt,app_pred):
    # https://scikit-learn.org/stable/modules/generated/sklearn.metrics.max_error.html#sklearn.metrics.max_error
    return max_error(app_gt,app_pred)
