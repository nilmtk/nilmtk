...
class TestNode(unittest.TestCase):
    ...
    def test_unsatisfied_requirements(self):
        ...
        state = {"preprocessing": {"gaps_located": True, "energy_computed": False}, "sample_period": 6}
        unsatisfied = find_unsatisfied_requirements(state, requirements)
        self.assertEqual(unsatisfied, [])
        ...
        requirements = {"preprocessing": {"gaps_located": True, "energy_computed": True}, "sample_period": 100}
        state = {"preprocessing": {"gaps_located": True, "energy_computed": False}, "sample_period": 6}
        unsatisfied = find_unsatisfied_requirements(state, requirements)
        self.assertEqual(len(unsatisfied), 2)
        ...
        requirements = {}
        state = {"preprocessing": {"gaps_located": True, "energy_computed": True}, "sample_period": 100}
        unsatisfied = find_unsatisfied_requirements(state, requirements)
