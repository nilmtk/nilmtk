...
class TestElecMeter(WarningTestMixin, unittest.TestCase):
    ...
    def test_total_energy(self):
        ...
        # Check period_range
        period_index = pd.period_range(start=meter.get_timeframe().start, periods=5, freq="D")
    ...
    def correlation(self):
        ...
        meter_2 = ElecMeter(store=self.datastore, metadata=self.meter_meta, meter_id=METER_ID2)
