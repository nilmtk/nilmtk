...
class TestMeterGroup(unittest.TestCase):
    ...
    def test_getitem(self):
        ...
        # test good keys
        for key in ["fridge", ("fridge", 1), {"type": "fridge"}, {"type": "fridge", "instance": 1}]:
            self.assertEqual(mg[key], fridge_meter)

        # test bad key values
        for key in ["foo", ("foo", 2), ("fridge", 2), {"type": "fridge", "instance": -12}]:
    ...
    def test_wiring_graph(self):
        meter1 = ElecMeter(metadata={"site_meter": True}, meter_id=ElecMeterID(1, 1, "REDD"))
    ...
    def test_dual_supply(self):
        elec_meters = {
            1: {"data_location": "/building1/elec/meter1", "device_model": "Energy Meter"},
            2: {"data_location": "/building1/elec/meter1", "device_model": "Energy Meter"},
            3: {"data_location": "/building1/elec/meter1", "device_model": "Energy Meter"},
        }
        ...
        self.assertEqual(mg["washer dryer"].total_energy()["active"], mg["fridge"].total_energy()["active"] * 2)
