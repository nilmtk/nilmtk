...
def plot_series(series, ax=None, fig=None, date_format="%d/%m/%y %H:%M:%S", tz_localize=True, **kwargs):
...
def plot_pairwise_heatmap(df, labels, edgecolors="w", cmap=matplotlib.cm.RdYlBu_r, log=False):
    """
