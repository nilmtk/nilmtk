...
class Appliance(Hashable):
    ...
    def __init__(self, metadata=None):
        ...
        if self.identifier.type and self.identifier.type not in Appliance.appliance_types:
            warn(
    ...
    def on_power_threshold(self):
        ...
        try:
            ...
            threshold_from_appliance_type = self.type.get("on_power_threshold", DEFAULT_ON_POWER_THRESHOLD)
