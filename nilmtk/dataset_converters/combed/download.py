...
def download():
    ...
    lecture_block = {"AHU-1": [0], "AHU-2": [1], "AHU-3": [2], "Building Total Mains": [0], "Floor Total": [0, 1, 2]}

    load_renaming = {"AHU-1": "AHU", "AHU-2": "AHU", "AHU-3": "AHU", "Power": "Power Sockets", "UPS": "UPS Sockets"}
