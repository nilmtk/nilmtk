...
class MeterGroup(Electric):
    ...
    def _plot_sankey(self):
        ...
        """
        Computes parameters like fraction of energy, labels
        and orientations from elecmeter object and calls 
        matplotlib.sankey function to plot the data 

        """

        # Use fraction_per_meter() function to get energy 
        # fraction values of submeters
