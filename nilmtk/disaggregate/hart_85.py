...
class Hart85(Disaggregator):
	...
	def __init__(self,params):
		...
		self.buffer_size = params.get('buffer_size',20)
		self.state_threshold = params.get('state_threshold',15)
		self.min_tolerance = params.get('min_tolerance',100)
		self.noise_level = params.get('noise_level',70)
		self.percent_tolerance = params.get('percent_tolerance',0.035)
		self.large_transition = params.get('large_transition',1000)

	def partial_fit(
		self, train_main,train_appliances,**kwargs):
		"""
		...
		large_transition=self.large_transition
		self.appliances=[]
